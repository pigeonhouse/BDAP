...
export function downloadStream() {
    let flowInfo = {"nodes":[{
        ...
        "labelName":{
            ...
            "attributes":[{"labelName":{"label":"归一化类型","elabel":"normalizationType"},
            "valueType":"String","style":{"menu":[{"label":"MinMax","elabel":"MinMax"},
            {"label":"Standard","elabel":"Standard"},{"label":"MaxAbs","elabel":"MaxAbs"}]},
            "styleType":"Select","value":"MinMax"},{"labelName":{"label":"归一化字段",
            "elabel":"targetCols"},"valueType":"Array[String]","style":{"multiCol":"true",
            "sourceAnchor":"0"},"styleType":"ChooseCol","value":["col5"]}],"size":"200*40",
            "x":360.8999938964844,"y":305.5,"columnsInfo":[{"colName":"col4",
            "dataType":"dateTime"},{"colName":"col5","dataType":"date"},{"colName":"col2",
            "dataType":"float"},{"colName":"col3","dataType":"string"},{"colName":"col1",
            "dataType":"Int"}],"sourceIdList":["835ab143_0"]}],"edges":[{"source":"835ab143",
